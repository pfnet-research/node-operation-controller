...
.PHONY: test
test: manifests generate fmt vet setup-envtest kind-for-test ## Run tests.
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name node-operation-controller-builder
	$(CONTAINER_TOOL) buildx use node-operation-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm node-operation-controller-builder
	rm Dockerfile.cross
