...
import (
	...
	"github.com/pfnet-research/node-operation-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(nodeopsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "869fe74b.k8s.preferred.jp",
	...
	if err = (&controller.NodeRemediationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&controller.NodeRemediationTemplateReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
